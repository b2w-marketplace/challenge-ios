...
//  b2wChallenge
//
//  Created by Felipe Mac on 12/5/18.
...
class Utils: NSObject {
    ...
    static func formatNavigationController(view: UIViewController) {
    ...
    static func formatNavigationTitleFontWithDefaultStyle(view: UIViewController, description: String) {
        ...
        let titleDict: NSDictionary = [NSAttributedStringKey.foregroundColor: UIColor.white, NSAttributedStringKey.font: UIFont(name: "Helvetica-Bold", size: 20)!]
